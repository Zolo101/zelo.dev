...
<a
    href={ware.link}
    class="rounded backdrop-blur-xl ring-1 bg-amber-500/5 shadow-2xl px-0 mx-5 mb-4 flex gap-5 hover:bg-amber-500/10 transition-colors"
>
                    ...
                    {#if ware.source}
                        <a href={ware.source}>
                            <img
                                ...
                                width="64"
                                height="64"
                                class="opacity-40 hover:opacity-100 px-5 py-1.5 transition-opacity min-w-16"
                                src={github_icon}
                            />
                        </a>
                    {/if}
